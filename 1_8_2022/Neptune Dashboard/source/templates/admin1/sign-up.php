        ...
        <div class="app-auth-container">
            ...
            <form action="signUpback.php" method="POST">
                <div class="auth-credentials m-b-xxl">
                    ...
                    <input type="text" class="form-control m-b-md" placeholder="Enter Name" name="name">

                    <label for="signUpEmail" class="form-label">Email address</label>
                    <input type="email" class="form-control m-b-md" name="email" placeholder="example@neptune.com">
