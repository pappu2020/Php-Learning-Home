            ...
            <div class="row mainSectionStart">
                <div class="col-lg-3 mainSectionLeft">
                    ...
                    <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                        <span class="bd-highlight editIconPicDiv rounded rounded-circle"><svg xmlns="http://www.w3.org/2000/svg" class="editIconPic" width="24" height="24" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
                ...
                <div class="col-lg-8 mainSectionRight">
                    ...
                    ?>
                        ...
                        <div class="alert alert-success mt-5"><?= $_SESSION["addOfficerUpdateSuccess"]; ?></div>
