...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('dashboardAsset/images/favicon.png')}}">
	<link rel="stylesheet" href="{{asset('dashboardAsset/vendor/chartist/css/chartist.min.css')}}">
    <link href="{{asset('dashboardAsset/vendor/bootstrap-select/dist/css/bootstrap-select.min.css')}}" rel="stylesheet">
	<link href="{{asset('dashboardAsset/vendor/owl-carousel/owl.carousel.css')}}" rel="stylesheet">
    <link href="{{asset('dashboardAsset/css/style.css')}}" rel="stylesheet">
...
<body>
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="{{asset('dashboardAsset/images/logo.png')}}" alt="">
                <img class="logo-compact" src="{{asset('dashboardAsset/images/logo-text.png')}}" alt="">
                <img class="brand-title" src="{{asset('dashboardAsset/images/logo-text.png')}}" alt="">
            </a>
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{url("/userView")}}">User List</a></li>
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="{{asset('dashboardAsset/vendor/global/global.min.js')}}"></script>
	<script src="{{asset('dashboardAsset/vendor/bootstrap-select/dist/js/bootstrap-select.min.js')}}"></script>
	<script src="{{asset('dashboardAsset/vendor/chart.js/Chart.bundle.min.js')}}"></script>
    <script src="{{asset('dashboardAsset/js/custom.min.js')}}"></script>
	<script src="{{asset('dashboardAsset/js/deznav-init.js')}}"></script>
	<script src="{{asset('dashboardAsset/vendor/owl-carousel/owl.carousel.js')}}"></script>
