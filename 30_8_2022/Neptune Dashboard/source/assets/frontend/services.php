                                ...
                                <div class="card widget widget-stats">
                                    <div class="card-body">
                                        ...
                                        <form action="servicesBackend.php" method="POST">
                                            ...
                                            <textarea class="form-control" rows="3" placeholder="Service Description" name="serviceDescription"></textarea>
                                            ...
                                            <input type="text" class="form-control m-b-md mt-4" name="serviceIcon" placeholder="Service Icon">
                                            ...
                                            <button type="submit" class="btn btn-success mt-4" name="statusInsertBtn">Add Services</button>

                                            <?php
                                            if (isset($_SESSION["insert_Services_success"])) {
                                            ?>

                                                <div class=" alert alert-success mt-3 p-3">
                                                    <?php echo $_SESSION["insert_Services_success"]; ?>
                                                </div>
